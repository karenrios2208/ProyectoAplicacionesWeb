  ...
  const handleValidation = ()=>{
      ...
      if (typeof fields["password"] !== "undefined") {
        ...
        if (!strongRegex.test(fields["password"])) {
          error["password"] = "min 8 caracteres, una letra minúscula y una mayúscula, un número y un caracter especial";
          formIsValid = false;
        }
      }
      ...
      setError({username: error['username'], email: error['email'], nombres:  error['nombres'], apellidos:  error['apellidos'], password: error['password'], confirm_password:  error['confirm_password']});
      ...
      <DialogContent>
        ...
        {excep && <Alert severity="error">{excep}</Alert>}
          ...
          <TextField
            ...
            onChange={handleChange}
          />
          {errors["nombres"] && <Alert severity="error">{errors["nombres"]}</Alert>}
          ...
          {errors['apellidos'] && <Alert severity="error">{errors["apellidos"]}</Alert>}
          ...
          <TextField
            ...
            onChange={handleChange}
          />
          {errors["confirm_password"] && <Alert severity="error">{errors["confirm_password"]}</Alert>}
        </form>
      </DialogContent>
      <DialogActions>
